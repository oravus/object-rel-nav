...
import habitat_sim
from libs.common.utils_sim_traj import find_shortest_path, get_agent_rotation_from_two_positions
...
def get_goal_info_alt_goal(mapPath, task_type):
    ...
    seen_but_unvisited_object = np.load(f"{mapPath}/{goal_info_filename}", allow_pickle=True)[()]
...
def get_goalNodeIdx(mapPath, G, nodeID_to_imgRegionIdx, task_type, ret_final_goalMask_vis=False):
    """
